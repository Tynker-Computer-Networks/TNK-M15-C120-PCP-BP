...
class SecretSanta(Tk):
    def __init__(self):
        ...
        # Initialize is_reminder variable
        ...
        Label(self.frame, text="Participant Comma Seprated Wishlist:").grid(column=0, row=2, sticky="w")
        ...
        self.add_button = Button(self.frame, text="Add Participant", command=self.add_participant)
        ...
        self.attached_files_label.grid(column=0, row=7, sticky="w", padx=10, pady=5)
        ...
        # Create a Label with the name Check for Reminder.
        


        self.send_button = Button(self.frame, text="Send Assignments", command=self.handle_assignments)
    ...
    def send_assignments(self):
        ...
        messagebox.showinfo("Assignments Sent", "Assignments sent. Check your emails!")
    ...
    # Define schedule_reminder_email() function
